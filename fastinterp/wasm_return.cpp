...
struct FIReturnOpsImpl
{
    ...
    static OperandType f(uintptr_t stackframe, [[maybe_unused]] OpaqueParams... opaqueParams, [[maybe_unused]] OperandType qa1) noexcept
    {
...
void __pochivm_build_fast_interp_library__()
{
    ...
    RegisterBoilerplate<FIReturnOpsImpl>(FIAttribute::NoContinuation);
}
